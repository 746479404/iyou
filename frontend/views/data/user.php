            ...
            <div class="ucenter-info mt10">
                <div class="info">
                    ...
                    <div class="info-main">
                        ...
                        <div class="row">
                            <label>
                                配送地址：</label><?= $region;?></span></div>
                    </div>
                    <div style="float:right">
                        <?= HTML::button('编辑',['style'=>'width:150px;height:30px;background:#fff;font-size:16','id'=>'button']) ?>
                        <?= HTML::button('签到',['style'=>'width:150px;height:30px;background:#fff;font-size:16','id'=>'sign']) ?>
                    </div>
                    <script>
                        $(function(){
                            $("#sign").click(function(){
                                $.get("index.php?r=user/sign", function(data){
                                    if(data==1){
                                        alert("签到成功");
                                        history.go(0);
                                    }else if(data==2){
